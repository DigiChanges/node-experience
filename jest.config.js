...
module.exports = {
  ...
  collectCoverageFrom: [
      ...
      "!dist/src/Auth/**/*.{js,ts}",
      "!dist/src/Shared/Application/Logger.{js,ts}",
      "!dist/src/Shared/Infrastructure/AxiosHandler.{js,ts}",
      "!dist/src/Shared/Factories/CacheFactory.{js,ts}",
      "!dist/src/Shared/Factories/CronFactory.{js,ts}",
      "!dist/src/Shared/Infrastructure/Orm/MongooseAggregatePaginator.{js,ts}",
      "!dist/src/Shared/Infrastructure/Events/*.{js,ts}",
