...
import CategoryUpdatePayload from '../../../Category/Domain/Payloads/CategoryUpatePayload';
...
CategoryKoaHandler.post('/', AuthorizeKoaMiddleware(Permissions.CATEGORIES_SAVE), async(ctx: DefaultContext) =>
{
...
CategoryKoaHandler.get('/', AuthorizeKoaMiddleware(Permissions.CATEGORIES_LIST), async(ctx: DefaultContext) =>
{
...
CategoryKoaHandler.get('/:id', AuthorizeKoaMiddleware(Permissions.CATEGORIES_SHOW), async(ctx: DefaultContext) =>
{
...
CategoryKoaHandler.put('/:id', AuthorizeKoaMiddleware(Permissions.CATEGORIES_UPDATE), async(ctx: DefaultContext) =>
{
...
CategoryKoaHandler.delete('/:id', AuthorizeKoaMiddleware(Permissions.CATEGORIES_DELETE), async(ctx: DefaultContext) =>
{
